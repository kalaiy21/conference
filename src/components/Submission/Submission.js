          ...
          <div className="mt-[3rem] px-[5rem] leading-[2rem]">
            ...
            <p>
                ...
                <ul className="list-disc pl-[2rem]">
                    <li>Subject should be Paper submission to ICESC 2022 Conference.</li>
                    ...
                    <li>The Manuscript should strictly follow the IEEE paper template which is available below:</li>
                </ul>
            </p>
            ...
            <p>
                ...
                <p className=" mb-[1rem]">IEEE conference templates contain guidance text for composing and formatting conference papers. Please ensure that all guidance text is removed from your conference paper prior to submission to the conference.</p>
                <a href="https://www.ieee.org/conferences/publishing/templates.html" className="underline text-sky-500" target="_blank">IEEE Template</a>
            </p>
